...
<div id="myOverlay" class="overlay">
  ...
  <div class="overlay-content">
    <form  action="main1.php" method="POST" >
      <input type="text" placeholder="ENTER THE COACH NUMBER" name='c_no'  >
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>   
      <table width=40%  cellpadding="5"  cellspacing="2" align="margin-left">

      <form action="coa_insert.php" method="POST">
       <td colspan="2" align="center"> <h2><strong>ADD MASTER</strong></h2></td>
       <tr>
